...
struct Preference {
  ...
  static let defaultPreference: [Preference.Key: Any] = [
    ...
    .subTextColor: NSKeyedArchiver.archivedData(withRootObject: NSColor.white),
    .subBgColor: NSKeyedArchiver.archivedData(withRootObject: NSColor.clear),
    .subBold: false,
    .subItalic: false,
    .subBlur: Float(0),
    .subSpacing: Float(0),
    .subBorderSize: Float(3),
    .subBorderColor: NSKeyedArchiver.archivedData(withRootObject: NSColor.black),
    .subShadowSize: Float(0),
    .subShadowColor: NSKeyedArchiver.archivedData(withRootObject: NSColor.clear),
